...
def main():
    parser = argparse.ArgumentParser(description="Summarize WheelTech navigation rosbag (DWA/TEB compatible)")
    ...
    write_csv(os.path.join(out_dir, "wheeltec_odom_twist.csv"), ["t", "linear_x", "angular_z"], odom)
    ...
    lines = []
    lines.append("WheelTech navigation log summary (DWA/TEB compatible)")
